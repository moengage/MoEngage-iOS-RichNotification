...
/// \param request UNNotificationRequest instance that contains remote notification content
///
...
/// \param controller UIViewController instance to which the template needs to be added
///
